            ...
            <div className="flex flex-col sm:flex-row items-center justify-between">
                ...
                <div className="max-w-2xl ml-32 mx-auto mb-5">
                    ...
                    <blockquote className="leading-relaxed border-black border-l-4 pl-4 text-left text-black font-medium">
                        ...
                        <p className='mb-4'>
                        Recently, I have been exploring different ways to incorporate my artistic side along with my computer science background. As you can see on the site, some of my 3D models that I created and rigged in Blender are featured roaming about! This is a new endavour for me, and I hope to continue this further, adapting it to more websites, prorgram visualization, and even game development.
                        </p>
                        <p className='mb-4'>
                        On a professional level, I’ve also gained valuable, hands on experience for software development practices after working at theScore. I worked as a QA analyst for the promotions team, where I got the chance to test and find bugs for their upcoming features. This position introduced me to applying SDLC/Agile practices in a professional setting. I participated in daily standups, created concise testing notes, file bugs, and made lasting connections with some amazing people. 
                        </p>
                        <p className='mb-4'>
